<div>
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="{{route('admin.appointments.create')}}"> <button class="btn btn-primary">Add Appointment</button>
        </a>
    </div>
        ...
        <table class="table table-borderless table-data3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="" wire:click.prevent="edit()"> <i class="fa fa-edit mx-2 text-warning"></i> </a>
                        <a href="" wire:click.prevent="confirmUserRemoval()"> <i
